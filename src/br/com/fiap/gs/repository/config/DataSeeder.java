...
public class DataSeeder {
    ...
    public DataSeeder(FarmerRepository farmerRepository, PropertyRepository propertyRepository, AgroclimaticRepository agroclimaticRepository ) {
    ...
    private void seed() {
        ...
        Agroclimatic f2property2Agroclimatic1 = new Agroclimatic(F2_PROPERTY_1_AGROCLIMATIC_1, FARMER_2_PROPERTY_1, LocalDate.now(), 21, 8, 10, 67, 6);
        ...
        agroclimaticRepository.save(f2property2Agroclimatic1);
    }
}
